...
<!--        </el-dialog>-->
        ...
        <!--重命名dialog-->
                ...
                <div slot="footer" class="dialog-footer">
                  <el-button @click="dialog_rename=false">取消</el-button>
...
*/
    ...
    submit(){//创建默认文档
      var that = this;
      this.$http.get(this.$API + '/file/create/team/',
    ...
    permission_transfer(team_permission)//用于显示团队权限
    {
      ...
      renameFile() {
      var that = this;
      this.$http.post(this.$API + '/file/rename/', this.$qs.stringify({
                file_id: this.file_id_tmp,
        ...
        submit_setpri() {
      var that = this
      this.$http.post(this.$API + '/file/privi/team/', this.$qs.stringify({
  ...
  getUserInfo() {
    ...
    //这两个函数还没改完
     Customize(){
      ...
      var that=this;
      this.$http.post(this.$API + '/file/create/customize/team/',
              this.$qs.stringify({
    ...
    Model(){
              ...
              && that.modelFile.file_mod !=3 && that.modelFile.file_mod !=4)
      {
        ...
        this.$http
          .post(this.$API + '/file/create/model/team/',
              this.$qs.stringify({
